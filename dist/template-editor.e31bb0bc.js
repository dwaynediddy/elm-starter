			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Who is the best Rugby team in Poland?')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Which Hero dies in the fellowship of the ring??')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('where was jezen born?')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Who is the Black Mamba')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('View Results')
							]))
					]));
		default:
			return A2(
...
},{"process":"node_modules/process/browser.js"}],"notificationFx.js":[function(require,module,exports) {
/**
...
(function (window) {
  ...
  NotificationFx.prototype.dismiss = function () {
    ...
    setTimeout(function () {
      self.ntf.classList.add('ns-hide'); // callback
...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"notificationFx.css":[function(require,module,exports) {
...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"assets/styles/skeleton.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"assets/styles/main.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
//# sourceMappingURL=/app/template-editor/template-editor.e31bb0bc.js.map