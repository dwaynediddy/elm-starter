...
window.templateEditor = function (node, flags) {
  var app = _Main.Elm.Main.init({
    node: document.getElementById(node),
    flags: flags
  });

  app.ports.showModal.subscribe(function (a) {
    Avgrund.show('#' + a);
  });
  app.ports.hideModal.subscribe(function () {
    Avgrund.hide();
  });
  app.ports.reportErrors.subscribe(function (errors) {
    for (var i = 0; i < errors.length; i++) {
      console.error(errors[i]);
    }
  });
  app.ports.growl.subscribe(function (msg) {
...
//# sourceMappingURL=/app/template-editor/index.js.map